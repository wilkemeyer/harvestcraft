...
/*     */     
/*     */ 
/*  27 */     addSlotToContainer(new SlotPamAnimalTrap(inv.player, tepa, 18, 26, 35));
/*     */     
...
/*  47 */       if (this.lastProduceTime != this.animaltrap.produceTime) {
/*  48 */         crafter.sendProgressBarUpdate(this, 1, this.animaltrap.produceTime);
/*     */       }
/*     */       
/*  51 */       if (this.lastRunTime != this.animaltrap.runTime) {
/*  52 */         crafter.sendProgressBarUpdate(this, 2, this.animaltrap.runTime);
/*     */       }
/*     */       
/*  55 */       if (this.lastBeeRunTime != this.animaltrap.currentBeeRunTime) {
/*  56 */         crafter.sendProgressBarUpdate(this, 3, this.animaltrap.currentBeeRunTime);
/*     */       }
/*     */     }
/*     */     
/*     */ 
/*  61 */     this.lastProduceTime = this.animaltrap.produceTime;
/*  62 */     this.lastRunTime = this.animaltrap.runTime;
/*  63 */     this.lastBeeRunTime = this.animaltrap.currentBeeRunTime;
/*     */   }
/*     */   
/*     */   public void updateProgressBar(int event, int val) {
/*  67 */     if (event == 1) {
/*  68 */       this.animaltrap.produceTime = val;
/*  69 */     } else if (event == 2) {
/*  70 */       this.animaltrap.runTime = val;
/*  71 */     } else if (event == 3) {
/*  72 */       this.animaltrap.currentBeeRunTime = val;
/*     */     }
/*     */   }
/*     */   
/*     */   public boolean canInteractWith(EntityPlayer player) {
/*  77 */     return this.animaltrap.isUseableByPlayer(player);
/*     */   }
/*     */   
...
/* Location:              C:\Users\Modding\Desktop\Pam's HarvestCraft 1.7.10k.deobf.jar!\com\pam\harvestcraft\ContainerPamAnimalTrap.class
