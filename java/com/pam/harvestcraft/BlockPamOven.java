...
/*     */   {
/*  44 */     return Item.getItemFromBlock(BlockRegistry.pamOven);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 102 */     this.blockIcon = p_149651_1_.registerIcon("harvestcraft:ovenside");
/* 103 */     this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "harvestcraft:ovenfronton" : "harvestcraft:ovenfrontoff");
/* 104 */     this.field_149935_N = p_149651_1_.registerIcon("harvestcraft:oventop");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 112 */     par5EntityPlayer.openGui(harvestcraft.instance, 5, par1World, par2, par3, par4);
/* 113 */     return true;
/*     */   }
/*     */   
/*     */ 
...
/* 125 */     if (p_149931_0_)
/*     */     {
/* 127 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockRegistry.pamOvenon);
/*     */     }
/*     */     else
/*     */     {
/* 131 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockRegistry.pamOven);
/*     */     }
/*     */     
...
/*     */     {
/* 181 */       ((TileEntityOven)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 189 */       TileEntityOven tileentityoven = (TileEntityOven)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
/*     */       
/* 191 */       if (tileentityoven != null)
/*     */       {
/* 193 */         for (int i1 = 0; i1 < tileentityoven.getSizeInventory(); i1++)
/*     */         {
/* 195 */           ItemStack itemstack = tileentityoven.getStackInSlot(i1);
/*     */           
...
/*     */   {
/* 263 */     return Item.getItemFromBlock(BlockRegistry.pamOven);
/*     */   }
/*     */ }


/* Location:              C:\Users\Modding\Desktop\Pam's HarvestCraft 1.7.10k.deobf.jar!\com\pam\harvestcraft\BlockPamOven.class
