...
/*     */   
/*     */   public BlockPamQuern(boolean p_i45407_1_) {
...
/*     */   {
/*  44 */     return Item.getItemFromBlock(BlockRegistry.pamQuern);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 102 */     this.blockIcon = p_149651_1_.registerIcon("harvestcraft:quernside");
/* 103 */     this.field_149936_O = p_149651_1_.registerIcon(this.field_149932_b ? "harvestcraft:quernfronton" : "harvestcraft:quernfrontoff");
/* 104 */     this.field_149935_N = p_149651_1_.registerIcon("harvestcraft:querntop");
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */   {
/* 112 */     par5EntityPlayer.openGui(harvestcraft.instance, 7, par1World, par2, par3, par4);
/* 113 */     return true;
/*     */   }
/*     */   
/*     */ 
/*     */ 
/*     */ 
/*     */   public static void updateQuernBlockState(boolean p_149931_0_, World p_149931_1_, int p_149931_2_, int p_149931_3_, int p_149931_4_)
/*     */   {
...
/* 125 */     if (p_149931_0_)
/*     */     {
/* 127 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockRegistry.pamQuernon);
/*     */     }
/*     */     else
/*     */     {
/* 131 */       p_149931_1_.setBlock(p_149931_2_, p_149931_3_, p_149931_4_, BlockRegistry.pamQuern);
/*     */     }
/*     */     
...
/*     */   {
/* 149 */     return new TileEntityQuern();
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */     {
/* 181 */       ((TileEntityQuern)p_149689_1_.getTileEntity(p_149689_2_, p_149689_3_, p_149689_4_)).func_145951_a(p_149689_6_.getDisplayName());
/*     */     }
/*     */   }
/*     */   
...
/*     */     {
/* 189 */       TileEntityQuern tileentityquern = (TileEntityQuern)p_149749_1_.getTileEntity(p_149749_2_, p_149749_3_, p_149749_4_);
/*     */       
/* 191 */       if (tileentityquern != null)
/*     */       {
/* 193 */         for (int i1 = 0; i1 < tileentityquern.getSizeInventory(); i1++)
/*     */         {
/* 195 */           ItemStack itemstack = tileentityquern.getStackInSlot(i1);
/*     */           
...
/*     */   {
/* 263 */     return Item.getItemFromBlock(BlockRegistry.pamQuern);
/*     */   }
/*     */ }


/* Location:              C:\Users\Modding\Desktop\Pam's HarvestCraft 1.7.10k.deobf.jar!\com\pam\harvestcraft\BlockPamQuern.class
