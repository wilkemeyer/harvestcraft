...
public class TileEntityPamAnimalTrap extends TileEntity implements IInventory {
                ...
                for (int offsetX = -radius; offsetX <= radius; ++offsetX) {
                        for (int offsetZ = -radius; offsetZ <= radius; ++offsetZ) {
                                if (offsetX * offsetX + offsetZ * offsetZ <= radius * radius
                                        ...
                                        if (world.getBlock(varX + offsetX, varY, varZ + offsetZ) == BlockRegistry.pamanimalTrap) {
        ...
        public ItemStack getComb() {
                ...
                if (this.inventory[18] != null) 
                {
                   ...
                   if (this.inventory[18].getItem() == ItemRegistry.fruitbaitItem) 
                   {
                       ...
                       switch (rndnum)
                       {
                       case 0: return new ItemStack(ItemRegistry.rabbitrawItem, 1, 0);
                       ...
                       case 5: return new ItemStack(ItemRegistry.rabbitrawItem, 1, 0);
                       case 6: return new ItemStack(ItemRegistry.rabbitrawItem, 1, 0);
                       case 7: return new ItemStack(Items.chicken, 1, 0);
                       case 8: return new ItemStack(Items.chicken, 1, 0);
                   ...
                   if (this.inventory[18].getItem() == ItemRegistry.veggiebaitItem) 
                   {
                       ...
                       case 1: return new ItemStack(ItemRegistry.muttonrawItem, 1, 0);
