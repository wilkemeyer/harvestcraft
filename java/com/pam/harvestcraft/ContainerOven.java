...
/*     */       
/*  61 */       if (this.lastCookTime != this.tileOven.ovenCookTime)
/*     */       {
/*  63 */         icrafting.sendProgressBarUpdate(this, 0, this.tileOven.ovenCookTime);
/*     */       }
/*     */       
/*  66 */       if (this.lastBurnTime != this.tileOven.ovenBurnTime)
/*     */       {
/*  68 */         icrafting.sendProgressBarUpdate(this, 1, this.tileOven.ovenBurnTime);
/*     */       }
/*     */       
/*  71 */       if (this.lastItemBurnTime != this.tileOven.currentItemBurnTime)
/*     */       {
/*  73 */         icrafting.sendProgressBarUpdate(this, 2, this.tileOven.currentItemBurnTime);
/*     */       }
/*     */     }
/*     */     
/*  77 */     this.lastCookTime = this.tileOven.ovenCookTime;
/*  78 */     this.lastBurnTime = this.tileOven.ovenBurnTime;
/*  79 */     this.lastItemBurnTime = this.tileOven.currentItemBurnTime;
/*     */   }
/*     */   
...
/*  85 */     if (p_75137_1_ == 0)
/*     */     {
/*  87 */       this.tileOven.ovenCookTime = p_75137_2_;
/*     */     }
/*     */     
/*  90 */     if (p_75137_1_ == 1)
/*     */     {
/*  92 */       this.tileOven.ovenBurnTime = p_75137_2_;
/*     */     }
/*     */     
/*  95 */     if (p_75137_1_ == 2)
/*     */     {
/*  97 */       this.tileOven.currentItemBurnTime = p_75137_2_;
/*     */     }
/*     */   }
/*     */   
/*     */   public boolean canInteractWith(EntityPlayer p_75145_1_)
/*     */   {
/* 103 */     return this.tileOven.isUseableByPlayer(p_75145_1_);
/*     */   }
/*     */   
/*     */ 
/*     */ 
...
/*     */       {
/* 130 */         if (OvenRecipes.smelting().getSmeltingResult(itemstack1) != null)
/*     */         {
...
/*     */           }
/*     */         }
/* 137 */         else if (TileEntityOven.isItemFuel(itemstack1))
/*     */         {
...
/* Location:              C:\Users\Modding\Desktop\Pam's HarvestCraft 1.7.10k.deobf.jar!\com\pam\harvestcraft\ContainerOven.class
